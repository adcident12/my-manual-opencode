...
| [plugins.md](plugins.md) | superpowers, custom plugin `graft-deep` และ `ponytail` (โค้ดเต็ม + Plugin Hook API ของ OpenCode) |
...
- **Plugins**: [superpowers](https://github.com/obra/superpowers) (skill library) + custom `graft-deep` plugin + [ponytail](https://github.com/dietrichgebert/ponytail) (code minimization ruleset)
